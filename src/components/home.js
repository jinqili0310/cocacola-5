 ...
 * @LastEditTime: 2020-11-06 19:18:38
 * @FilePath: /cocacola-5/src/components/home.js
 */
					...
					<Col className="col-card">
						<Card className="product-card product-cc">
							...
							<Card.Body className="product-card-body">
								...
								<Button variant="dark" className="button-style" href="/cocacola-5/#/products/coca-cola/explore/">
									EXPLORE
								</Button>
							</Card.Body>
						</Card>
